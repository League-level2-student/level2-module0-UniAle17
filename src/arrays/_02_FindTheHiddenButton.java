...
public class _02_FindTheHiddenButton implements ActionListener{
	...
	public void start() {
		...
		String pn = JOptionPane.showInputDialog("Enter a positive number");
		...
		JOptionPane.showMessageDialog(null, "Watch carefully for the , 'Me' and click the button where it appeared");
	...
	public void actionPerformed(ActionEvent e) {
		...
		//18. else tell them to try again
			...
			JOptionPane.showMessageDialog(null, "Wrong Button! You loose");
		}
	}
}
